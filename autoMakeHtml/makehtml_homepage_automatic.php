...
$templet = empty($templet)? 'default/index.htm' : $templet;
$saveset = empty($saveset)? 1 : $saveset;
$showmod = empty($showmod)? 1 : $showmod;
$remotepos = empty($remotepos)? '/index.html' : $remotepos;
$isremote = empty($isremote)? 0 : $isremote;
$serviterm = empty($serviterm)? "" : $serviterm;
$position = empty($position)? "../index.html" : $position;
